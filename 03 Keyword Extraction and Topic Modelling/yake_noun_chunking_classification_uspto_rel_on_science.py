...
def main():
    ...
    # Delete all rows except 'id', 'doi', 'title', 'abstract', 'oaid', 'full_oaid'
    ...
    df.to_json('/mnt/hdd01/patentsview/Reliance on Science - Cleantech Patents/df_oaid_Cleantech_y02_individual_works_lang_detect_yake_noun_chunks.json', orient='records')
