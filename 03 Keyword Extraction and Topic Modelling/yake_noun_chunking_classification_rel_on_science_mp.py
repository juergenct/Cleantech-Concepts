...
def main():
    ...
    df = df[['doi', 'title', 'abstract', 'oaid', 'full_oaid']]
    ...
    df.to_json('/mnt/hdd01/patentsview/Non Cleantech Patents - Classifier Set/df_oaids_non_cleantech_lang_detect_yake_noun_chunks.json', orient='records')
